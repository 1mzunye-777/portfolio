...
export const SITE_URL = "https://www.google.com";

export const PROFILE = {
  name: "Geoffrey Musungu",
  firstName: "Geoffrey",
  role: "Software Development Engineer",
  status: "Software engineer · currently online Freelancing",
  taglines: [
  ...
  bio: "I design and ship products end to end across web, mobile, backends, and the automation between them. I own the full stack: Laravel, Next.js, Flutter from zero. Plus AI in production: RAG with Pinecone, OCR workflows, and automation that cuts real operational drag.",
  about: {
    ...
    p2: " I'm rebuilding a production Laravel system into a modern architecture while delivering a Flutter app from scratch — handling legacy code, performance constraints, and scalability challenges in real-world systems.",
    p3: "I focus on building simple, fast, and maintainable systems — designed for actual usage, not just clean implementations.",
    credentials: [
      "B.Tech, IT — UMMA (2020–2024)",
      "Freelancing  — Online (2020–2026)",
      "Certified: Programmer · AI · Flutter",
      "Currently @ Freelancing, Kenya",
    ],
  },
  email: "geoffreymuli2000@gmail.com",
  location: "Nairobi, Kenya",
  resume: "#",
  siteUrl: `${SITE_URL}/`,
  socials: {
    github: "https://github.com/mzunye-777",
    linkedin: "https://www.linkedin.com/KE/geoffreymusungu",
...
export const EXPERIENCE: Job[] = [
  ...
  {
    company: "Online Freelancing",
    title: "Software Engineer and Web Development",
    range: "Aug 2021 — Present",
    location: "Bangalore · Full-time",
    blurb:
      "Built the internal CRM platform used by 1500+ across sales, risk, and growth. Automated the boring parts.",
    points: [
      "Built an internal CRM on Firebase Auth + serverless architecture — 1500+ active users across sales, risk, and growth",
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    colorA: "#7c3aed",
    colorB: "#1da1f2",
    link: "https://github.com/mzunye-777/twitterclone",
    linkLabel: "View on GitHub",
  },
  {
    id: "claude-tracker",
    title: "Claude-Tracker",
    meta: "2025 · macOS · Swift",
    ...
    colorA: "#d97757",
    colorB: "#f0abfc",
    link: "https://github.com/mzunye-777/Claude-Tracker",
    linkLabel: "View on GitHub",
  },
  {
    id: "save-image-as",
  ...
  },
  {
    ...
    colorA: "#22d3ee",
    colorB: "#a3e635",
    link: "https://github.com/mzunye-777/puzzleIT",
    linkLabel: "View on GitHub",
  },
  {
    id: "traffic-analyzer",
    ...
    colorA: "#ef4444",
    colorB: "#fbbf24",
    link: "https://github.com/mzunye-777/Traffic-Density-Analyzer",
    linkLabel: "View on GitHub",
  },
  {
    id: "whilegptthinks",
    title: "WhileGPTThinks",
    meta: "2023 · Chrome extension",
    ...
    colorA: "#ff4444",
    colorB: "#f0abfc",
    link: "https://github.com/mzunye-777/whilegptthinks",
    linkLabel: "View on GitHub",
  },
];

export const ARCHIVE_URL = "https://github.com/mzunye-777";
